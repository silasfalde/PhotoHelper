...
class PhotoHelperTests(unittest.TestCase):
    ...
    def test_framing_pipeline_processes_and_validates(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self._make_image(source_dir / "landscape.jpg", (2000, 1200), (40, 50, 60))
            ...
            self.assertEqual(processed_files, ["landscape_L.jpg", "landscape_R.jpg", "portrait.jpg"])
            self.assertEqual(framed_files, ["landscape_L.jpg", "landscape_R.jpg", "portrait.jpg"])
